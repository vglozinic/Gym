...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/dodaj_moderatora.js"></script>
    </head>
    ...
    <body>
        <div id="stretcher">
            <div id="container">
                ...
                <div id="content">
                    <h2>Dodavanje moderatora</h2>
                    <div id="error_status"></div>
                    <div id="div_korisnik">
                        <label class="label_prijava" for="korisnik"><span class="podebljano">Korisnik</span></label>
                        <br>
                        <select id="korisnik" name="Korisnik" class="input"></select>
                        <br>
                    </div>
                    <a href="a_moderatori.php"><button class="gumb margin_top">Natrag</button></a>
                    <button class="gumb margin_top" id="dodaj" type="button">Dodaj</button>
                </div>   
