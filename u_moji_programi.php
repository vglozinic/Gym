...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/moji_programi.js"></script>
    </head>
    ...
    <body>
        <div id="stretcher">
            <div id="container">
                ...
                <div id="content">
                    <h2>Programi u kojima sudjelujem</h2>
                    <div id="select">
                        <select id="program" name="Program" class="input"></select>
                    </div>
                    <div id="zabranjen"></div>
                    <div id="opis">
                        
                    </div>
                    <div id="gumbi">
                        <button class="gumb margin_top" id="dolasci" type="button">Dolasci</button>
                    </div>
                </div>
